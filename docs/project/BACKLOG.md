...
## Upcoming Iteration: Milestone 3 (Phase 03 — Daily Journey & Card Architecture)
*Status: LOCKED until TASK-030 is completed and Gate 2 is closed.*

- [ ] **TASK-031**: Author detailed 60-minute daily journey specification across MacBook Air M4 and Galaxy S24 Ultra based on calibrated vector $\vec{P}$.
- [ ] **TASK-032**: Specify and prototype Anki note types (HTML/CSS templates for the 4 standardized note types).
- [ ] **TASK-033**: Document native FSRS configuration preset and step-by-step Anki Desktop setup guide.
